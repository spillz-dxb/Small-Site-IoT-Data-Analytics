...
![spark-iot-ts architecture]( Introduction-to-statistics/images/1 Nominal ordinal interval and ratio data How to Remember the differences YouTube.png?raw=true "ordinal, interval and ratio data")
